...
import PracticeDescriptionEditor from '../practices/PracticeDescriptionEditor';
...
const validationSchema = Yup.object().shape({
  ...
  description: Yup.string().min(1, TOO_SHORT).required(REQUIRED),
  province: Yup.array().min(1, REQUIRED).required(REQUIRED),
  programs: Yup.array().min(1, REQUIRED).required(REQUIRED),
  source_type: Yup.array().min(1, REQUIRED).required(REQUIRED),
  source_description: Yup.string().required(REQUIRED),
  source_url: Yup.string().url(INCORRECT_FORMAT).required(REQUIRED),
